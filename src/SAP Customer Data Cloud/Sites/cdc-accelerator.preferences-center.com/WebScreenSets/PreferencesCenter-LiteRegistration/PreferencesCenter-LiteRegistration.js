export default {
    ...
    var formEl = document.getElementById(event.form);
        var checkboxes = formEl.querySelectorAll("div.gg-required-checkbox input[data-screenset-roles='instance']");
            ...
            if (isFirstLoop) {
                checkboxEl.addEventListener('click', function(ev) {
                    if (ev.target.checked) {
                        ev.target.parentNode.classList.remove('gg-checkbox-error');
                    }
                });
            }
